  ...
  <body>
	<div class="container-fluid">
      ...
      <li><a href="payment1 .php">ชำระเงิน</a></li>
        ...
        <br>
        <div class="mainmenu">
	<center><font style="font-size: 28px;color: black;">การจัดส่งสินค้า</font></center>
			<hr>
		</div>
        <?php
        $serverName = "localhost";
    ...
    <center>
		<div align="center" style="width: 400px" class="panel panel-default">
            ...
            <small><a href="edit_addressuser.php?number=<?php echo $objResult["number"];?>">แก้ไข</a></small> | <small><a href="delete_addressuser.php?number=<?php echo $objResult["number"];?>">ลบ</a></small>
            </div>
            <?php
  					}
					?>
        ...
        <div class="form-group">
			<div class="text-center">
			  <a href="editaddress.php"><button type="submit" class="btn btn-success">เพื่อที่อยู่การจัดส่งสินค้า</button></a>
	</div>
