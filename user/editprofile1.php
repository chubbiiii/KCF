...
?>
  <body>
	<div class="container-fluid">
        ...
        <br>
        <div class="mainmenu">
	<center><font style="font-size: 28px;color: black;">ข้อมูลส่วนตัว</font></center>
			<hr>
		</div>

    <form class="form-horizontal" action="save_editprofile1.php" method="post">
        <div class="form-group">
          <label class="col-sm-4 control-label">UserID</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="UserID" id="UserID" value="<?php echo $objResult["UserID"];?>"readonly>
            </div>
        </div>
		<div class="form-group">
          <label class="col-sm-4 control-label">ชื่อ</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="name" id="name" value="<?php echo $objResult["name"];?>"readonly>
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">นามสกุล</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="lastname" id="lastname" value="<?php echo $objResult["lastname"];?>"readonly>
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">เบอร์โทรศัพท์</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="tel" id="tel" value="<?php echo $objResult["tel"];?>"readonly>
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">อีเมล์</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="email" id="email" value="<?php echo $objResult["email"];?>"readonly>
            </div>
        </div>
        <div class="form-group">
		  <label class="col-sm-4 control-label">เพศ</label>
			...
			<select name="sex" id="sex" class="form-control" placeholder="เพศ" required>
   			<option value="<?php echo $objResult["sex"];?>"readonly><?php echo $objResult["sex"];?></option>
          </select>
			</div>
        </div>
        <div class="form-group">
            ...
            <option value="<?php echo $objResult["birthday"];?>"readonly><?php echo $objResult["birthday"];?></option>
			</select>
			</div>
            </div>
        <div class="form-group">
			<label class="col-sm-4 control-label">เดือนเกิด</label>
			<div class="col-sm-1">
			<select name="birthmonth" id="birthmonth" class="form-control" required>
            <option value="<?php echo $objResult["birthmonth"];?>"readonly><?php echo $objResult["birthmonth"];?></option>
			</select>
			</div>
		  </div>
          <div class="form-group">
			<label class="col-sm-4 control-label">ปีเกิด</label>
			<div class="col-sm-1">
			<select name="birthyear" id="birthyear" class="form-control" required>
            <option value="<?php echo $objResult["birthyear"];?>"readonly><?php echo $objResult["birthyear"];?></option>
			</select>
			</div>
		  </div>
          <div class="form-group">
			<label class="col-sm-4 control-label">LINE ID</label>
			<div class="col-sm-4">
            <input type="text" class="form-control" name="lineid" id="lineid" value="<?php echo $objResult["LINE_ID"];?>"readonly>
			</div>
            </div>
	</form>	
