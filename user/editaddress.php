...
<form class="form-horizontal" action="save_editaddress.php" method="post">
...
<tr>
    ...
    <tr>
        ...
        <td class="text-left">
            <input name="name" id="name" class="form-control" value="<?php echo $objResult["name"];?>">
        </td>        
    </tr>
    <tr>
	<td width="100" class="text-right">
        ...
        <td class="text-left">
            <input name="lastname" id="lastname" class="form-control" value="<?php echo $objResult["lastname"];?>">
        </td>        
    </tr>
    <tr>
	<td width="100" class="text-right">
	...
	<td width="100" class="text-right">
        ...
        <td class="text-left">
            <input name="lineid" id="lineid" class="form-control" value="<?php echo $objResult["LINE_ID"];?>">
        </td>        
    </tr>
    <tr>
        <td class="text-right">
    ...
    <tr>
        ...
        <td class="text-left">
        <input type="text" id="amphoe" name="amphoe" class="form-control">
        </td>        
    </tr>
    <tr>
        <td width="100" class="text-right">
