...
<center><h1>คำสั่งซื้อ</h1></center><br>
<center><table class="table table-hover">
  <tr>
    <td width="5"><center>OrderID</td>
    <td width="40"><center>UserID</td>
    <td width="120"><center>วันที่สั่งซื้อ</td>
    <td width="120"><center>ชื่อ</td>
	<td width="50"><center>บ้านเลขที่</td>
    <td width="50"><center>ตำบล/แขวง</td>
    <td width="50"><center>อำเภอ/เขต</td>
    <td width="60"><center>จังหวัด</td>
    <td width="60"><center>รหัสไปรษณีย์</td>
    <td width="40"><center>สถานะ</td>
    <td width="40"><center>เลขพัสดุ</td>
    <td width="40"><center>แสดง</td>
    <td width="40"><center>แจ้งโอนเงิน</td>
  </tr>
  <?php
  $strEmail = null;
...
$serverName = "localhost";
 ...
 $objCon = mysqli_connect($serverName,$userName,$userPassword,$dbName);
 mysqli_set_charset($objCon, "utf8");
 $strSQL = "SELECT * FROM orders WHERE UserID = '".$_SESSION['UserID']."' ";
 $objQuery = mysqli_query($objCon,$strSQL);
?>
 <?php
...
<tr>
        ...
        <td><center><?=$objResult["track"];?></td>
        <td><center>
        <div class="form-group">
			<div class="">
      <a href="view_order2.php?orderID=<?php echo $objResult["orderID"];?>"><button type="submit" class="btn btn-success">แสดง</button></a></div></td>
			</div>
		  </div>
      <td><center>
        <div class="form-group">
			<div class="">
      <a href="payment.php?orderID=<?php echo $objResult["orderID"];?>"><button type="submit" class="btn btn-danger">โอนเงิน</button></a></div></td>
			</div>
		  </div>
