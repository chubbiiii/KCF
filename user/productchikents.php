	  ...
	  <div class="row">
			...
			<div class="col-sm-9">
                ...
                <br>		
					...
					<tr>
							<th width="400px"><center><a target="" href="#detailproduct.php?productID=<?php echo $objResult["productID"];?>"><img src="/kcf/admin/backoffice/img_pro/all/<?php echo $objResult["picture"];?>" class='img-responsive' style='min-height:150px;height:150px;'></a></center>
							...
							<th><center><div class="btn-group" style="height:50px;"><a target="" href="order.php?productID=<?php echo $objResult["productID"];?>"><img src='img/cart.png' width="300px"></div></a></center>
						</tr>
						</table>
						<hr>
					<?php
