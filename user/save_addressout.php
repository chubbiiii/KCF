...
?>
<center><h1>เลือกที่อยู่จัดส่ง</h1></center><br>
<center><table class="table table-hover">
  <tr>
    ...
    <td width="100"><center>ราคาทั้งหมด</td>
  </tr>
  <?php
  $Total = 0;
  $SumTotal = 0;
...
จำนวนเงินที่ต้องชำระ <?php echo number_format($SumTotal,2);?> บาท
<br><br>
<?php
...
if(isset($_GET["number"]))
{
    $strnumber = $_GET["number"];
        ...
        <form class="form-horizontal" action="save_checkout.php" method="post">
        <div class="form-group">
          <label class="col-sm-4 control-label">ชื่อ</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="name" id="name" value="<?php echo $objResult["name"];?>">
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">นามสกุล</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="lastname" id="lastname" value="<?php echo $objResult["lastname"];?>">
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">บ้านเลขที่</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="address" id="address" value="<?php echo $objResult["address"];?>">
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">ตำบล/แขวง</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="district" id="district" value="<?php echo $objResult["district"];?>">
            </div>
        </div><div class="form-group">
          <label class="col-sm-4 control-label">อำเภอ/เขต</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="amphur" id="amphur" value="<?php echo $objResult["amphur"];?>">
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">จังหวัด</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="province" id="province" value="<?php echo $objResult["province"];?>">
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">รหัสไปรษณีย์</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="zipcode" id="zipcode" value="<?php echo $objResult["zipcode"];?>">
            </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">เบอร์โทรศัพท์</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="tel" id="tel" value="<?php echo $objResult["tel"];?>">
            </div>
        </div>
        <div class="form-group">
