...
?>
		<center>
		<h1>หน้าชำระเงิน</h1>
<form class="form-horizontal" name="form1" method="post" action="PageFiles2.php" enctype="multipart/form-data">
<div class="form-group">
          <label class="col-sm-4 control-label">เลข Order</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="orderid" id="orderid" value="<?php echo $objResult["orderID"];?>"readonly>
			</div>
	</div>
        <div class="form-group">
          <label class="col-sm-4 control-label">เอกสารชำระเงิน</label>
			<div class="col-sm-4">
		    <input type="file" class="form-control" name="filUpload" id="filUpload" value="">
			</div>
	</div>
	<div class="form-group">
			<div class="text-center">
			  <button type="submit" name="btnSubmit" class="btn btn-success">ชำระเงิน</button>
