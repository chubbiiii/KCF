...
<?php
  ...
  $objCon = mysqli_connect($serverName,$userName,$userPassword,$dbName);
  mysqli_set_charset($objCon, "utf8");
  $strSQL = "SELECT * FROM payment WHERE orderID";
  $objQuery = mysqli_query($objCon,$strSQL);
?>
<center>
<h1>เอกสารการโอนเงิน</h1><br>
<table class="table table-hover">
<tr>
<th width="50"> <div align="center">OrderID </div></th>
<th width="150"> <div align="center">เอกสารการโอนเงิน</div></th>
</tr>
<?php
...
<td><center><a href="/kcf/user/Bill/<?php echo $objResult["Bill"];?>"><?php echo $objResult["Bill"];?></a></center></td>
</tr>
<?php
    }
    ?>  
</table>
<div class="btn-group"><a href="clearbill.php"><div class="text-center"><button type="submit" class="btn btn-danger" onclick="return confirm('ต้องการลบบิลทั้งหมดใช่หรือไม่? **เมื่อลบแล้วจะไม่สามารถเรียกคืนข้อมูลได้**')">เครียร์บิล</button></a>
</center>
