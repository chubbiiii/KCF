  ...
  <body>
	<div class="container-fluid">
      ...
      <li><a href="addproduct.php">เพิ่มสินค้า</a></li>
        ...
        <center><h1>รายละเอียดของ Orders</h1></center><br>
<center><table class="table table-hover">
  <tr>
    <td width="30"><center>OrderID</td>
    <td width="100"><center>OrderDate</td>
    <td width="130"><center>ชื่อ</td>
    <td width="130"><center>ที่อยู่</td>
    <td width="100"><center>ตำบล</td>
    <td width="70"><center>อำเภอ</td>
    <td width="100"><center>จังหวัด</td>
    <td width="50"><center>รหัสไปรษณีย์</td> 
    <td width="100"><center>เบอร์โทรศัพท์</td>
    <td width="100"><center>Status</td>  
    <td width="40"><center>UserID</td>  
    <td width="40"><center>แก้ไข</td> 
    <td width="40"><center>ลบ</td>
  </tr>
  <?php
  $orderID = null;
...
<tr>
		...
		<td><center><?=$objResult["orderDate"];?></td>
		<td><center><?=$objResult["name"];?></td>
		<td><center><?=$objResult["address"];?></td>
        <td><center><?=$objResult["district"];?></td>
        <td><center><?=$objResult["amphur"];?></td>
        <td><center><?=$objResult["province"];?></td>
        <td><center><?=$objResult["zipcode"];?></td>
        <td><center><?=$objResult["tel"];?></td>
        <td><center><?=$objResult["status"];?></td>
        <td><center><?=$objResult["UserID"];?></td>
        <td><center><div class="form-group">
			<div class="">
            <a href="view_order_admin.php?orderID=<?php echo $objResult["orderID"];?>"><button type="submit" class="btn btn-success">แก้ไขรายละเอียด</button></a></div>
			</div>
          </div></td>
          <td><center>
        <div class="form-group">
			<div class="">
      <a href="JavaScript:if(confirm('คุณต้องการลบ Order นี้ออกจากระบบหรือไม่?')==true){window.location='delete_order_admin.php?orderID=<?php echo $objResult["orderID"];?>';}">
      <button type="submit" class="btn btn-danger">ลบ</button></a></td>
      </div>
          </div>
         </td>
