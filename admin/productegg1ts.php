...
$strSQL = "SELECT * FROM product WHERE category='productegg1ts'";
mysqli_set_charset($objCon, "utf8");
$objQuery = mysqli_query($objCon,$strSQL);
if(!$objQuery)
{
...
<div class="container-fluid">
	  ...
	  <p class="breadcrumb">หน้าหลัก > <font color="#000000">ไข่ไก่แปรรูป อัพเดตวันที่ "<?=date('d-m-Y')?>"</font></p>
	  <hr>
	  <div class="row">
			<div class="col-sm-3">
				<div class="row">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<center><p><h4><font color="#a5c63b">หมวดหมู่ : ไข่ไก่แปรรูป</font></h4></p></center>
			...
			<div class="col-sm-9">
                ...
                <br>		
					...
					<tr>
							<th width="400px"><center><a target="" href="#detailproduct.php?productID=<?php echo $objResult["productID"];?>"><img src="backoffice/img_pro/all/<?php echo $objResult["picture"];?>" class='img-responsive' style='min-height:150px;height:150px;'></a></center>
						
							<th width="700px"><center><h4 style="height:20px;"><?php echo  $objResult["productName"];?></h4></center></th>
							<div class="caption">
							<th><center><h4 style="height:20px;">ราคา <?php echo  $objResult["price"];?></h4></center></th>
							<th><center><div class="btn-group" style="height:50px;"><a target="" href="editproduct.php?productID=<?php echo $objResult["productID"];?>"><img src='img/cart.png' width="300px"></div></a></center>
							<center><div class="btn-group"><a href="JavaScript:if(confirm('คุณต้องการลบสินค้านี้ออกจากระบบหรือไม่?')==true){window.location='delete_product_admin.php?productID=<?php echo $objResult["productID"];?>';}"><img src='img/bin.png' width="300px"></div></a></center>
						</tr>
						</table>
						<hr>
					<?php
