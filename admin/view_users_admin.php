...
<center><h1>รายละเอียดของ Users</h1></center><br>
<center><table class="table table-hover">
  <tr>
    <td width="40"><center>number</td>
    <td width="40"><center>UserID</td>
    <td width="100"><center>LINE ID</td>
	<td width="100"><center>จังหวัด</td>
    <td width="100"><center>อำเภอ</td>
    <td width="100"><center>ตำบล</td>
    <td width="70"><center>รหัสไปรษณีย์</td>
    <td width="100"><center>ที่อยู่</td>
    <td width="100"><center>จุดสังเกตุ</td>  
  </tr>
  <?php
  $UserID = null;
...
$objCon = mysqli_connect($serverName,$userName,$userPassword,$dbName);
mysqli_set_charset($objCon, "utf8");
$strSQL = "SELECT * FROM addressuser WHERE UserID = '".$UserID."' ";
$objQuery = mysqli_query($objCon,$strSQL);
...
?>
<tr>
        <td><center><?=$objResult["number"];?></td>
		<td><center><?=$objResult["UserID"];?></td>
		<td><center><?=$objResult["LINE_ID"];?></td>
        ...
        <td><center><?=$objResult["address1"];?></td>
