...
<div class="container-fluid">
	  ...
	  <p class="breadcrumb">หน้าหลัก > <font color="#000000">เพิ่มสินค้า "<?=date('d-m-Y')?>"</font></p>
	  <hr>
	  <div class="row">
			<div class="col-sm-3">
				<div class="row">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<center><p><h4><font color="#a5c63b">หมวดหมู่ : เพิ่มสินค้า</font></h4></p></center>
...
<form class="form-horizontal" name="form1" method="post" action="PageFiles3.php" enctype="multipart/form-data">
<div class="form-group">
          <label class="col-sm-4 control-label">ชื่อสินค้า</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="nameproduct" id="nameproduct" value="" required>
			</div>
	</div>
	<div class="form-group">
          <label class="col-sm-4 control-label">ราคาสินค้า</label>
			<div class="col-sm-4">
		    <input type="text" class="form-control" name="productprice" id="productprice" value="" required>
			</div>
	</div>
	<div class="form-group">
          <label class="col-sm-4 control-label">หมวดหมู่สินค้า</label>
		    ...
		    <select name="productcategory" id="productcategory" class="form-control" required>
   			<option value="new">สินค้าโปรโมชั่น</option>
        ...
        <div class="form-group">
          <label class="col-sm-4 control-label">รูปสินค้า</label>
			<div class="col-sm-4">
		    <input type="file" class="form-control" name="filUpload" id="filUpload" value="" required>
			</div>
	</div>
	<div class="form-group">
			<div class="text-center">
			  <button type="submit" name="btnSubmit" class="btn btn-success">เพิ่มสินค้า</button>
