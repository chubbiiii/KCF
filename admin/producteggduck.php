...
$strSQL = "SELECT * FROM product WHERE category='producteggduck'";
mysqli_set_charset($objCon, "utf8");
$objQuery = mysqli_query($objCon,$strSQL);
if(!$objQuery)
{
...
<div class="container-fluid">
	  ...
	  <p class="breadcrumb">หน้าหลัก > <font color="#000000">ไข่เป็ด อัพเดตวันที่ "<?=date('d-m-Y')?>"</font></p>
	  <hr>
	  <div class="row">
			<div class="col-sm-3">
				<div class="row">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<center><p><h4><font color="#a5c63b">หมวดหมู่ : ไข่เป็ด</font></h4></p></center>
