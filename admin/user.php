...
<center><h1>จัดการ Users</h1></center><br>
<center><table class="table table-hover">
  <tr>
    <td width="40"><center>UserID</td>
    <td width="120"><center>ชื่อ</td>
    <td width="120"><center>นามสกุล</td>
	<td width="120"><center>เบอร์โทรศัพท์</td>
    <td width="300"><center>Email</td>
    <td width="50"><center>เพศ</td>
    <td width="60"><center>วันเกิด</td>
    <td width="100"><center>เดือนเกิด</td>
    <td width="40"><center>ปีเกิด</td>
    <td width="40"><center>รายละเอียดที่อยู่</td>
...
$serverName = "localhost";
 ...
 $objCon = mysqli_connect($serverName,$userName,$userPassword,$dbName);
 mysqli_set_charset($objCon, "utf8");
 $strSQL = "SELECT * FROM member WHERE UserID";
 $objQuery = mysqli_query($objCon,$strSQL);
?>
 <?php
...
<tr>
		...
		<td><center><?=$objResult["lastname"];?></td>
		<td><center><?=$objResult["tel"];?></td>
		<td><center><?=$objResult["email"];?></td>
        <td><center><?=$objResult["sex"];?></td>
        <td><center><?=$objResult["birthday"];?></td>
        <td><center><?=$objResult["birthmonth"];?></td>
        <td><center><?=$objResult["birthyear"];?></td>
        <td><center>
        <div class="form-group">
			<div class="">
            <a href="view_users_admin.php?UserID=<?php echo $objResult["UserID"];?>"><button type="submit" class="btn btn-success">รายละเอียดที่อยู่</button></a></div>
			</div>
          </div>
         </td>
         <td><center>
        <div class="form-group">
			<div class="">
      <a href="JavaScript:if(confirm('คุณต้องการลบ Email นี้ออกจากระบบหรือไม่?')==true){window.location='delete_users_admin.php?UserID=<?php echo $objResult["UserID"];?>';}">
